...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_image = pygame.image.load('images/tiles/' + filename)
        self.original_image = pygame.transform.scale(self.original_image, (128, 128))


        self.back_img = pygame.Surface((100, 100))  # Create a blank surface
    ...
    def update(self):
        self.image = self.original_image if self.shown else self.back_img
...
class Game():
    def __init__(self):
        ...
        # aliens
        self.all_aliens = [f for f in os.listdir('images/tiles') if os.path.join('images/tiles', f)]
    ...
    def draw(self):
        ...
        content_font = pygame.font.Font('fonts/Halloween.ttf', 24)
