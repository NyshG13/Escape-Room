...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_img = pygame.image.load('memory game/images/tiles/'+filename)
...
class Game():
    def __init__(self):
        ...
        #tiles 
        self.all_tiles = [f for f in os.listdir('memory game/images/tiles/') if os.path.join('memory game/images/tiles/', f)]  #this uses os module to create an array of the name of all the images 
        ...
        self.sound_on = pygame.image.load('memory game/images/sound on.png').convert_alpha()
        self.sound_on = pygame.transform.scale(self.sound_on, (30,30))
        self.sound_off = pygame.image.load('memory game/images/sound off.png').convert_alpha()
        ...
        #load music 
        pygame.mixer.music.load('memory game/sounds/memory game sound.mp3')
    ...
    def draw(self):
        ...
        #fonts
        title_font = pygame.font.Font('memory game/fonts/Halloween.ttf', 44)
        content_font = pygame.font.Font('memory game/fonts/HallowenInline.ttf', 24)
    ...
    def get_video(self):
        self.cap = cv2.VideoCapture('memory game/video/midnight video.mp4')
        self.success, self.img = self.cap.read()
...
current_room_state_game3 = 'rubble'
...
while running:
    ...
    for event in event_list:
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE and current_room_state_game3 == 'room3':
                running = False
                pygame.mixer.music.pause()
