...
pygame.mixer.music.load('music/sliding.mp3')
...
bg = pygame.image.load("sliding game/villa sliding game.jpg")
...
font_title = pygame.font.Font('sliding game/Hello Avocado.ttf', 64)
font_content = pygame.font.Font('sliding game/Hello Avocado.ttf', 30)
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_RETURN and is_game_over: #enter key
                current_state_game = "room3"
                # is_game_over = False
